/*This Quicksort is implemented recursivly with the faster Hoare’s partition scheme. We use the median of three fixed elements for the pivot element. 
  This prevents the O(N^2) worst case from occurring with random or sorted data, but not with specially prepared input data.
  Here we use blocking, as demonstrated by by Edelkamp and A. Weiss https://arxiv.org/abs/1604.06697.
*/
...
/*Everything below is just demonstrating the work above.*/
